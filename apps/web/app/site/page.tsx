...
import { getPublicRepairData, getPublicRepairDataByUsername, projectDuration, repairClassMultipliers, repairRates, repairTypeMultipliers } from '@/lib/repair/platform';
...
export default function RepairSitePage() {
  ...
  useEffect(() => {
    setLandingUsername(new URLSearchParams(window.location.search).get('u'));
  }, []);
